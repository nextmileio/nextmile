...
import { useDispatch } from '../../../../Interview/ShortlistView/node_modules/src/store';
import {
  deleteCard,
  updateCard,
  addChecklist
} from '../../../../Interview/ShortlistView/node_modules/src/slices/kanban';
...
const CardEditModal = ({ card, className, list, onClose, open, ...rest }) => {
      ...
      <div className={classes.root}>
        ...
        <Grid container spacing={5}>
          ...
          <Grid item xs={12} sm={4}>
            ...
            <ActionButton icon={<UsersIcon />} onClick={handleAddChecklist}>
              Labels
            </ActionButton>
            <ActionButton icon={<FileIcon />} onClick={handleAddChecklist}>
              Attachments
            </ActionButton>
            <Box mt={3}>
              <Typography variant="overline" color="textSecondary">
